...
<h2>Perbarui Detail Transaksi</h2>
<form method="POST">
  Transaksi:
  ...
  <select name="type" required>
    ...
    <option value="Credit" <?php if ($row['type'] == 'Credit') echo 'selected'; ?>>Kredit</option>
  </select><br>

  Jumlah: <input type="number" name="amount" step="0.01" value="<?php echo $row['amount']; ?>" required><br>

  <input type="submit" value="Perbarui Detail Transaksi">
</form>