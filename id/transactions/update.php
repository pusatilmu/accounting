...
<h2>Perbarui Transaksi</h2>
<form method="POST">
  Tanggal: <input type="date" name="date" value="<?php echo $row['date']; ?>" required><br>
  Deskripsi: <input type="text" name="description" value="<?php echo $row['description']; ?>" required><br>
  Total: <input type="number" name="total" value="<?php echo $row['total']; ?>" step="0.01" required><br>
  <input type="submit" value="Perbarui Transaksi">
</form>